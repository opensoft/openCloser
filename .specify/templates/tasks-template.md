...
**Tests**: The examples below include test tasks. Include tests or explicit
demo checks whenever required by the feature specification or the openCloser
Constitution. Core queue, CRM write-back, duplicate-event, eligibility,
persona-result, and safety behavior require focused verification.
...
- [ ] T010 Define correlation IDs and structured logging fields required by the constitution
- [ ] T011 Define idempotency keys for queue claims, mock/provider events, and write-back jobs
- [ ] T012 Configure DNC/opt-out, call-window, and attempt-limit policy defaults
...
### Tests or Demo Checks for User Story 1

> **NOTE**: When automated tests are included, write them first and ensure they
> fail before implementation. When a manual demo check is used instead, document
> the exact command, fixture, or CRM record that proves the behavior.
...
- [ ] T015 [P] [US1] Fixture test for duplicate events, blocked attempts, or persona result mapping in tests/integration/test_[name].py
...
- [ ] T022 [US1] Add CRM write-back or local write-back payload mapping
- [ ] T023 [US1] Add human callback/review task behavior when required
...
### Tests or Demo Checks for User Story 2
...
### Tests or Demo Checks for User Story 3
...
- [ ] TXXX CRM write-back, idempotency, and human-handoff verification
