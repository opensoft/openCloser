...
- Q: What is the precise definition of "phone presence" for FR-004(a)? → A: Slice 1: non-null AND non-empty after trim (no whitespace-only strings). E.164 hard validation is deferred until the real-telephony slice because SignalWire requires it.
